...
class SetTdlibParameters extends TdFunction {
  ...
  factory SetTdlibParameters.fromMap(Map<String, dynamic> json) =>
      SetTdlibParameters(
        useTestDc: json["useTestDc"] as bool,
        databaseDirectory: json["databaseDirectory"] as String,
        filesDirectory: json["filesDirectory"] as String,
        databaseEncryptionKey: json["databaseEncryptionKey"] as String,
        useFileDatabase: json["useFileDatabase"] as bool,
        useChatInfoDatabase: json["useChatInfoDatabase"] as bool,
        useMessageDatabase: json["useMessageDatabase"] as bool,
        useSecretChats: json["useSecretChats"] as bool,
        apiId: json["apiId"] as int,
        apiHash: json["apiHash"] as String,
        systemLanguageCode: json["systemLanguageCode"] as String,
        deviceModel: json["deviceModel"] as String,
        systemVersion: json["systemVersion"] as String,
        applicationVersion: json["applicationVersion"] as String,
        enableStorageOptimizer: json["enableStorageOptimizer"] as bool,
        ignoreFileNames: json["ignoreFileNames"] as bool,
      );
