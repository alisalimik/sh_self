...
class User extends TdObject {
  ...
  static User? fromJson(
    ...
    return User(
      ...
      usernames: Usernames.fromJson(
        json['usernames'] as Map<String, dynamic>?,
      ),
      phoneNumber: json['phone_number'] as String,
      status: UserStatus.fromJson(
      ...
      isCloseFriend: (json['is_close_friend'] ?? false) as bool,
      ...
      hasActiveStories: (json['has_active_stories'] ?? false) as bool,
      hasUnreadActiveStories:
          (json['has_unread_active_stories'] ?? false) as bool,
      haveAccess: (json['have_access'] ?? false) as bool,
      type: UserType.fromJson(
