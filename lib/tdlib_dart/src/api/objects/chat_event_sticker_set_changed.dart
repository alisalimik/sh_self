...
class ChatEventStickerSetChanged extends ChatEventAction {
  ...
  static ChatEventStickerSetChanged? fromJson(
    ...
    return ChatEventStickerSetChanged(
      oldStickerSetId: int.tryParse(json['old_sticker_set_id'].toString()) ?? 0,
      newStickerSetId: int.tryParse(json['new_sticker_set_id'].toString()) ?? 0,
    );
  }
