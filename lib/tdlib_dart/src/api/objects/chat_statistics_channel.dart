...
class ChatStatisticsChannel extends ChatStatistics {
  ...
  static ChatStatisticsChannel? fromJson(
    ...
    return ChatStatisticsChannel(
      ...
      recentMessageInteractions:
        ...
        ((json['recent_message_interactions'] as List<dynamic>?) ?? <dynamic>[])
            .map(
              (item) => ChatStatisticsMessageInteractionInfo.fromJson(
