...
class ChatEventPhotoChanged extends ChatEventAction {
  ...
  static ChatEventPhotoChanged? fromJson(
    ...
    return ChatEventPhotoChanged(
      oldPhoto: ChatPhoto.fromJson(
        json['old_photo'] as Map<String, dynamic>?,
      ),
      newPhoto: ChatPhoto.fromJson(
        json['new_photo'] as Map<String, dynamic>?,
      ),
    );
  }
