...
class DiceStickersSlotMachine extends DiceStickers {
  ...
  static DiceStickersSlotMachine? fromJson(
    ...
    return DiceStickersSlotMachine(
      ...
      lever: Sticker.fromJson(
        json['lever'] as Map<String, dynamic>?,
      )!,
      leftReel: Sticker.fromJson(
        json['left_reel'] as Map<String, dynamic>?,
      )!,
      centerReel: Sticker.fromJson(
        json['center_reel'] as Map<String, dynamic>?,
      )!,
      rightReel: Sticker.fromJson(
        json['right_reel'] as Map<String, dynamic>?,
      )!,
    );
  }
