...
/// user confirms adding, then use toggleBotIsAddedToAttachmentMenu to add it.
/// If the attachment menu bot can't be used in the opened chat, show an error
/// to the user. If the bot is added to attachment menu and can be used in the
/// chat, then use openWebApp with the given URL
@immutable
