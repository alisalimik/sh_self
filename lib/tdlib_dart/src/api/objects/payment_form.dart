    ...
    return PaymentForm(
      ...
      savedCredentials: List<SavedCredentials>.from(
        ((json['saved_credentials'] as List<dynamic>?) ?? <dynamic>[])
            .map(
              (item) => SavedCredentials.fromJson(
                item as Map<String, dynamic>?,
              ),
            )
            .toList(),
      ...
      productPhoto: Photo.fromJson(
        json['product_photo'] as Map<String, dynamic>?,
      ),
    );
  }
