...
import 'package:sh_self/tdlib_dart/src/client/td_error.dart' as client_error;
import 'package:sh_self/tdlib_dart/src/client/td_function_exception.dart';
...
class ClientImpl implements Client {
  ...
  T execute<T extends TdObject>(TdFunction function) {
    ...
    final TdObject? object = result.toTdObject();
    if (object == null) {
